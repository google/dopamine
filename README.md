...
pip install mock absl-py atari-py gin-config gym opencv-python tensorflow-gpu
```
...
pip install mock absl-py atari-py gin-config gym opencv-python tensorflow
```
